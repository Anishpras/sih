...
const AdminRegister = () => {
  ...
  const [mediationCentreId, setMediationCentreId] = useState("");
  const [username, setUsername] = useState("");
  const [mediationAdminId, setMediationAdminId] = useState("");
  ...
  const { mutate, error } = trpc.useMutation(
    ["mediation-admin.mediation-admin-register"],
    {
      onError: (error: any) => {
        console.log(error);
      },
    ...
    <div className={loginScreenContainer}>
      ...
      <div className={loginScreenFormContainer}>
        ...
        <form className={formContainer}>
          ...
          <input
            type="text"
            value={mediationCentreId}
            placeholder={"Mediation Centre Id"}
            className={CustomInputStyle}
            onChange={(e) => setMediationCentreId(e.target.value)}
          />
          <input
            type="text"
            value={username}
          ...
          <input
            type="text"
            value={mediationAdminId}
            className={CustomInputStyle}
            placeholder={"AdminId"}
            onChange={(e) => setMediationAdminId(e.target.value)}
          />
          <input
            type="password"
            value={password}
