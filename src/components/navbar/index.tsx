...
export const Header = () => {
  return (
    <div className="style min-h-20 sticky top-0 z-50 m-auto flex   w-full flex-wrap py-4 pl-3 leading-[25.6px] filter backdrop-blur-[20px] md:w-[calc(100vw-240px)] md:justify-between  ">
      <div className="max-w-full">
        <nav className="font-Recursive text-base ">
        ...
        <div>
          <h1 className="font-Montserrat text-4xl">Main Dashboard</h1>
        </div>
      </div>
      <div className=" px-4">
        <div className=" customShadow relative flex w-full items-center justify-center rounded-3xl px-3 mt-3 md:mt-0  bg-white py-2 md:right-[6%] md:w-[270px] md:max-w-full  ">
          ...
          <button type="button" className="px-1 md:hidden">
            <BurgerIcon />
          </button>
