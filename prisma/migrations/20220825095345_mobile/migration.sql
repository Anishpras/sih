/*
  ...
  - Added the required column `mobile` to the `ArbitrationCentre` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ArbitrationCentre" ("arbitrationCentreId", "createdAt", "description", "id", "name", "password", "updatedAt") SELECT "arbitrationCentreId", "createdAt", "description", "id", "name", "password", "updatedAt" FROM "ArbitrationCentre";
